...
see "Hashing password using Argon2id with OpenSSL-generated salt..." + nl
...
if argon2id_verify(cEncodedHash, "wrong_password")
...
if argon2id_verify("invalid_hash_string", cPassword)
    see "Verification successful! (This is a security flaw!)" + nl
else
    see "Verification FAILED! (Correct)" + nl
ok
